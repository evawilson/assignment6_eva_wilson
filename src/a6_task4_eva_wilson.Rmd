...
**Figure 1. Mono Lake Levels** Depicts the change in water level (in feet above sea level) at Mono Lake, California between 1850-2017. There is an overall decline in lake levels because water is diverted to Los Angeles for drinking. The maximum lake level is `r max(mono_lake$lake_level)`ft above sea level, and the minimum is `r min(mono_lake$lake_level)` ft above sea level. Stable lake levels, represented by the dashed blue line, are considered `r mono_lake$stable_level[1]` feet above sea level. 
Three water levels represent an issue for habitat health and bird populations. Starting at 6,377 feet above sea level, or the area on the graph represented by the yellow rectangle, land bridges start to form. This can have an adverse affect on bird populations because predators can access their nesting sites. At 6,360 feet, or the area on the graph represented by the orange rectangle, salinity levels in the lake are low enough (120 g/L) that they reduce food resources (Bine Shrimp populations) for eared grebes and California gulls. At 6,350 feet above sea level, or the area on the graph represented by the red rectangle, salinity levels in the lake are considered acute (150 g/L) and therefore severely affact shrimp and bird populations.  
